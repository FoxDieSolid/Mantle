...
{
    public class MantleStorageConfiguration : IMongoDbConfiguration, IConfigurable
    {
        ...
        public void Validate()
        {
            if (String.IsNullOrEmpty(ConnectionString))
                throw new ConfigurationErrorsException("MongoDb storage connection string is required.");
        }
